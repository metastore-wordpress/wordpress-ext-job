...
/**
 * Class WP_EXT_Job_Template
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Job_Template extends WP_EXT_Job {
 ...
 *
 * @return WP_EXT_Job_Template
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Job_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Job_Template;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Job_Template(), 'run' ] );
