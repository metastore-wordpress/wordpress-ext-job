...
/**
 * Class WP_EXT_Job_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Job_Post_Type extends WP_EXT_Job {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Вакансии', 'Job General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Вакансия', 'Job Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Вакансии', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Вакансия', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Вакансия', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Job Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
			'supports'            => [ 'title' ],
			'hierarchical'        => false,
			'public'              => true,
 ...
 *
 * @return WP_EXT_Job_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Job_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Job_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Job_Post_Type(), 'run' ] );
