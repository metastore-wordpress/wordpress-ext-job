...
/**
 * Class WP_EXT_Job_Taxonomy
 */
class WP_EXT_Job_Taxonomy extends WP_EXT_Job {
	...
	public function taxonomy_meta() {
		$labels  = [
			'name'                       => _x( 'Job Meta', 'Meta General Name', 'wp-ext-' . $this->domain_ID ),
 ...
 *
 * @return WP_EXT_Job_Taxonomy
 */
function WP_EXT_Job_Taxonomy() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Job_Taxonomy;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Job_Taxonomy(), 'run' ] );
