...
/**
 * Class WP_EXT_Job_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Job_Theme extends WP_EXT_Job {
 ...
 *
 * @return WP_EXT_Job_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Job_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Job_Theme;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Job_Theme(), 'run' ] );
